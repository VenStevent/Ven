...
module.exports = async function handler(req, res) {
  ...
  try {
    if (req.method === "GET") {
      ...
      // Fix double-encoded: kalau ids tersimpan sebagai string JSON, parse sekali lagi
    ...
    if (req.method === "POST") {
      ...
      // Simpan sebagai array langsung (bukan string) untuk menghindari double-encoding
