...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    for (const p of presences) {
      ...
      // Kalau perubahan status terdeteksi
      if (prevP !== undefined && prevP !== currentPresence) {
        ...
        // Akun baru yang pertama kali dicek statusnya sudah offline, dan belum
        // pernah punya lastSeen tersimpan sama sekali -> catat waktu sekarang
        // sebagai estimasi awal, supaya tidak kosong selamanya sampai dia online dulu.
        lastSeen[userId] = now;
        changed = true;
      }
